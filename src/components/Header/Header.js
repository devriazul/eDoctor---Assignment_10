      ...
      <Navbar bg="light" expand="lg" className="px-3">
        <Container fluid>
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            <Button variant="outline-danger" onClick={()=>{navigete('signup')}} className={user ? "signup-btn border-0 rounded-0 ms-2 px-4 d-none ": "signup-btn border-0 rounded-0 ms-2 px-4 "}>Sign up</Button>
